...
if __name__ == "__main__":
    ...
    if not os.path.exists("experiment4/dataset_composition1000.json"):
        print("dataset.json not found — run dataset.py first.")
        exit(1)

    tokenizer = SROTokenizer.from_dataset("experiment4/dataset_composition1000.json")
    tokenizer.save("experiment4/tokenizer1000.json")
