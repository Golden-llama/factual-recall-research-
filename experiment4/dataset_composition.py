...
def make_composition_queries(entities, pos_per_pair=10, neg_per_pair=10, seed=32) -> List[Query]:
    random.seed(seed)
    value_to_entities = defaultdict(list)
...
def build_dataset(n_entities=1500, seed=32, comp_train_frac=0.5, pos_per_pair=10, neg_per_pair=10):
    random.seed(seed)
