...
summed_model = load_model("outputs/4000/summed/model_best.pt",       "summed",       cfg, device)
disent_model = load_model("outputs/4000/disentangled/model_best.pt", "disentangled", cfg, device)
