...
from dataset_extraction   import build_dataset, save_dataset, get_dataloaders, load_dataset, build_capacity_dataset, generate_entity_pool
...
if __name__ == "__main__":
    ...
    # Tokenizer
    cfg = Config()
    all_entities = generate_entity_pool(n_total = 10000)
    tokenizer = SROTokenizer([e["name"] for e in all_entities])
    tokenizer.save("tokenizer10000.json")
    cfg.vocab_size = tokenizer.vocab_size
    train_queries, test_queries = build_capacity_dataset(all_entities, n_train = 10000)
...
from dataset_extraction import EXTRACTION_RELATIONS
