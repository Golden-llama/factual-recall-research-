...
class SROTokenizer:
    ...
    @classmethod
    def from_dataset(cls, dataset_path: str = "experiment1/dataset_extraction10000.json") -> "SROTokenizer":
        """
    ...
    def save(self, path: str = "experiment1/tokenizer10000.json"):
        with open(path, "w") as f:
            json.dump({"token2id": self.token2id}, f, indent=2)
        print(f"  Tokenizer saved → {path}")

    @classmethod
    def load(cls, path: str = "experiment1/tokenizer10000.json") -> "SROTokenizer":
        """
...
if __name__ == "__main__":
    ...
    if not os.path.exists("experiment1/dataset_extraction5000.json"):
        print("dataset.json not found — run dataset.py first.")
        exit(1)

    tokenizer = SROTokenizer.from_dataset("experiment1/dataset_extraction10000.json")
    tokenizer.save("experiment1/tokenizer10000.json")
